...
public class AdminActivity extends AppCompatActivity {
    ...
    private static final String TAG_ADD_SURVEY= "add";
    private static final String TAG_REPORT_SURVEY = "report";
    ...
    private void loadNavHeader() {
        ...
        LoginUser savedUser = new Gson().fromJson(AdminActivity.this.getSharedPreferences(MY_LOGIN_PREF, Context.MODE_PRIVATE).getString(MY_LOGIN_PREF_KEY, ""), LoginUser.class);
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 2:
                // index
                AdminIndexFragmentSurvey adminIndexFragmentSurvey= new AdminIndexFragmentSurvey();
                return adminIndexFragmentSurvey;
            case 3:
                // add survey
                AdminAddSurveyFragment adminAddSurveyFragment = new AdminAddSurveyFragment();
                return adminAddSurveyFragment;
            case 4:
                // report survey
                AdminReportSurveyFragment adminReportSurveyFragment = new AdminReportSurveyFragment();
                return adminReportSurveyFragment;
            default:
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_index_survey:
                        ...
                        searchButton.setVisibility(View.VISIBLE);
                        break;
                    case R.id.nav_add_survey:
                        navItemIndex = 3;
                        CURRENT_TAG = TAG_ADD_SURVEY;
                        title.setText("Add Survey");
                       dataFalse();
                        break;
                    case R.id.nav_report_survey:
                        navItemIndex = 4;
                        CURRENT_TAG = TAG_REPORT_SURVEY;
                        title.setText("Report Survey");
                        dataFalse();
                        break;
                    default:
                        navItemIndex = 0;
